#ifndef CAFFE_BASE_ORN_CONVOLUTION_LAYER_HPP_
#define CAFFE_BASE_ORN_CONVOLUTION_LAYER_HPP_
...
class BaseORNConvolutionLayer : public Layer<Dtype> {
 public:
  explicit BaseORNConvolutionLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
